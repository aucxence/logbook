...
@Component({
  selector: 'app-bs-note-disciplinaire',
  templateUrl: './bs-note-disciplinaire.component.html',
  styleUrls: ['./bs-note-disciplinaire.component.scss']
})
export class BsNoteDisciplinaireComponent implements OnInit {
  ...
  public bdLink = 'bs-notes-disciplinaires';
  public storageLink = 'BS/ND/';
  public companytag = '/BS/';
  public doctype = '/ND';

  public deviationpage = '/dashboard/bscourriersortant';
  public actualcomp = '/dashboard/bsnotedisciplinaire';
