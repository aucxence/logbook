...
@Component({
  selector: 'app-tm-note-disciplinaire',
  templateUrl: './tm-note-disciplinaire.component.html',
  styleUrls: ['./tm-note-disciplinaire.component.scss']
})
export class TmNoteDisciplinaireComponent implements OnInit {
  ...
  public bdLink = 'tm-notes-disciplinaires';
  public storageLink = 'TM/ND/';
  public companytag = '/TM/';
  public doctype = '/ND';

  public deviationpage = '/dashboard/tmcourriersortant';
  public actualcomp = '/dashboard/tmnotedisciplinaire';
