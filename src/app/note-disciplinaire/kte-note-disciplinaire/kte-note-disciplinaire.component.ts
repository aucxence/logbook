...
@Component({
  selector: 'app-kte-note-disciplinaire',
  templateUrl: './kte-note-disciplinaire.component.html',
  styleUrls: ['./kte-note-disciplinaire.component.scss']
})
export class KteNoteDisciplinaireComponent implements OnInit {
  ...
  public bdLink = 'kte-notes-disciplinaires';
  public storageLink = 'KTE/ND/';
  public companytag = '/KTE/';
  public doctype = '/ND';

  public deviationpage = '/dashboard/ktecourriersortant';
  public actualcomp = '/dashboard/ktenotedisciplinaire';
