...
@Component({
  selector: 'app-uc-note-disciplinaire',
  templateUrl: './uc-note-disciplinaire.component.html',
  styleUrls: ['./uc-note-disciplinaire.component.scss']
})
export class UcNoteDisciplinaireComponent implements OnInit {
  ...
  public bdLink = 'uc-notes-disciplinaires';
  public storageLink = 'UCASH/ND/';
  public companytag = '/UCASH/';
  public doctype = '/ND';

  public deviationpage = '/dashboard/uccourriersortant';
  public actualcomp = '/dashboard/ucnotedisciplinaire';
