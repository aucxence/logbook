...
@Component({
  selector: 'app-mc2-note-disciplinaire',
  templateUrl: './mc2-note-disciplinaire.component.html',
  styleUrls: ['./mc2-note-disciplinaire.component.scss']
})
export class Mc2NoteDisciplinaireComponent implements OnInit {
  ...
  public bdLink = 'mc2-notes-disciplinaires';
  public storageLink = 'MC2/ND/';
  public companytag = '/MC2/';
  public doctype = '/ND';

  public deviationpage = '/dashboard/mc2courriersortant';
  public actualcomp = '/dashboard/mc2notedisciplinaire';
