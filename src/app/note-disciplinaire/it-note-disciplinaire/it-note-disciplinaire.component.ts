...
@Component({
  selector: 'app-it-note-disciplinaire',
  templateUrl: './it-note-disciplinaire.component.html',
  styleUrls: ['./it-note-disciplinaire.component.scss']
})
export class ItNoteDisciplinaireComponent implements OnInit {
  ...
  public bdLink = 'it-notes-disciplinaires';
  public storageLink = 'IT/ND/';
  public companytag = '/IT/';
  public doctype = '/ND';

  public deviationpage = '/dashboard/itcourriersortant';
  public actualcomp = '/dashboard/itnotedisciplinaire';
