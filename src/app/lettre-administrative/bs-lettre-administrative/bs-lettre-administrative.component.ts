...
@Component({
  selector: 'app-bs-lettre-administrative',
  templateUrl: './bs-lettre-administrative.component.html',
  styleUrls: ['./bs-lettre-administrative.component.scss']
})
export class BsLettreAdministrativeComponent implements OnInit {
  ...
  public bdLink = 'bs-lettres-administratives';
  public storageLink = 'BS/LA/';
  public companytag = '/BS/';
  public doctype = '/LA';

  public deviationpage = '/dashboard/bscourriersortant';
  public actualcomp = '/dashboard/bslettreadministrative';
