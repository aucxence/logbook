...
@Component({
  selector: 'app-it-lettre-administrative',
  templateUrl: './it-lettre-administrative.component.html',
  styleUrls: ['./it-lettre-administrative.component.scss']
})
export class ItLettreAdministrativeComponent implements OnInit {
  ...
  public bdLink = 'it-lettres-administratives';
  public storageLink = 'IT/LA/';
  public companytag = '/IT/';
  public doctype = '/LA';

  public deviationpage = '/dashboard/itcourriersortant';
  public actualcomp = '/dashboard/itlettreadministrative';
