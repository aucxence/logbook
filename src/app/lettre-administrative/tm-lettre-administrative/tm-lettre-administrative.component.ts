...
@Component({
  selector: 'app-tm-lettre-administrative',
  templateUrl: './tm-lettre-administrative.component.html',
  styleUrls: ['./tm-lettre-administrative.component.scss']
})
export class TmLettreAdministrativeComponent implements OnInit {
  ...
  public bdLink = 'tm-lettres-administratives';
  public storageLink = 'TM/LA/';
  public companytag = '/TM/';
  public doctype = '/LA';

  public deviationpage = '/dashboard/tmcourriersortant';
  public actualcomp = '/dashboard/tmlettreadministrative';
