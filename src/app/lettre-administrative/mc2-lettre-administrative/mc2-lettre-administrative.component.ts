...
@Component({
  selector: 'app-mc2-lettre-administrative',
  templateUrl: './mc2-lettre-administrative.component.html',
  styleUrls: ['./mc2-lettre-administrative.component.scss']
})
export class Mc2LettreAdministrativeComponent implements OnInit {
  ...
  public bdLink = 'mc2-lettres-administratives';
  public storageLink = 'MC2/LA/';
  public companytag = '/MC2/';
  public doctype = '/LA';

  public deviationpage = '/dashboard/mc2courriersortant';
  public actualcomp = '/dashboard/mc2lettreadministrative';
