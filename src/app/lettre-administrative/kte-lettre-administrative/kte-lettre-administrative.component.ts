...
@Component({
  selector: 'app-kte-lettre-administrative',
  templateUrl: './kte-lettre-administrative.component.html',
  styleUrls: ['./kte-lettre-administrative.component.scss']
})
export class KteLettreAdministrativeComponent implements OnInit {
  ...
  public bdLink = 'kte-lettres-administratives';
  public storageLink = 'KTE/LA/';
  public companytag = '/KTE/';
  public doctype = '/LA';

  public deviationpage = '/dashboard/ktecourriersortant';
  public actualcomp = '/dashboard/ktelettreadministrative';
