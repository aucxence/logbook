...
@Component({
  selector: 'app-tm-bordereau-livraison',
  templateUrl: './tm-bordereau-livraison.component.html',
  styleUrls: ['./tm-bordereau-livraison.component.scss']
})
export class TmBordereauLivraisonComponent implements OnInit {
  ...
  public bdLink = 'tm-bordereaux-livraison';
  public storageLink = 'TM/BL/';
  public companytag = '/TM/';
  public doctype = '/BL';

  public deviationpage = '/dashboard/tmcourriersortant';
  public actualcomp = '/dashboard/tmlivraison';
