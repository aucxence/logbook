...
@Component({
  selector: 'app-bs-bordereau-livraison',
  templateUrl: './bs-bordereau-livraison.component.html',
  styleUrls: ['./bs-bordereau-livraison.component.scss']
})
export class BsBordereauLivraisonComponent implements OnInit {
  ...
  public bdLink = 'bs-bordereaux-livraison';
  public storageLink = 'BS/BL/';
  public companytag = '/BS/';
  public doctype = '/BL';

  public deviationpage = '/dashboard/bscourriersortant';
  public actualcomp = '/dashboard/bslivraison';
