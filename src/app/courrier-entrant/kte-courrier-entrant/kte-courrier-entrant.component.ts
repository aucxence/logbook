...
@Component({
  selector: 'app-kte-courrier-entrant',
  templateUrl: './kte-courrier-entrant.component.html',
  styleUrls: ['./kte-courrier-entrant.component.scss']
})
export class KteCourrierEntrantComponent implements OnInit {
  ...
  public bdLink = 'kte-courriers-entrants';
  public storageLink = 'KTE/CE/';
  public companytag = '/KTE/';
  public doctype = '/CE/';

  public deviationpage = '/dashboard/ktecourriersortant';
  public actualcomp = '/dashboard/ktecourrierentrant';
