...
@Component({
  selector: 'app-bs-courrier-entrant',
  templateUrl: './bs-courrier-entrant.component.html',
  styleUrls: ['./bs-courrier-entrant.component.scss']
})
export class BsCourrierEntrantComponent implements OnInit {
  ...
  public bdLink = 'bs-courriers-entrants';
  public storageLink = 'BS/CE/';
  public companytag = '/BS/';
  public doctype = '/CE/';

  public deviationpage = '/dashboard/bscourriersortant';
  public actualcomp = '/dashboard/bscourrierentrant';
