...
@Component({
  selector: 'app-tm-courrier-entrant',
  templateUrl: './tm-courrier-entrant.component.html',
  styleUrls: ['./tm-courrier-entrant.component.scss']
})
export class TmCourrierEntrantComponent implements OnInit {
  ...
  public bdLink = 'tm-courriers-entrants';
  public storageLink = 'TM/CE/';
  public companytag = '/TM/';
  public doctype = '/CE/';

  public deviationpage = '/dashboard/tmcourriersortant';
  public actualcomp = '/dashboard/tmcourrierentrant';
