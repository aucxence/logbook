...
@Component({
  selector: 'app-it-courrier-entrant',
  templateUrl: './it-courrier-entrant.component.html',
  styleUrls: ['./it-courrier-entrant.component.scss']
})
export class ItCourrierEntrantComponent implements OnInit, OnDestroy {
  ...
  public bdLink = 'it-courriers-entrants';
  public storageLink = 'IT/CE/';
  public companytag = '/IT/';
  public doctype = '/CE/';

  public deviationpage = '/dashboard/itcourriersortant';
  public actualcomp = '/dashboard/itcourrierentrant';
