...
@Component({
  selector: 'app-uc-courrier-entrant',
  templateUrl: './uc-courrier-entrant.component.html',
  styleUrls: ['./uc-courrier-entrant.component.scss']
})
export class UcCourrierEntrantComponent implements OnInit {
  ...
  public bdLink = 'uc-courriers-entrants';
  public storageLink = 'UCASH/CE/';
  public companytag = '/UCASH/';
  public doctype = '/CE/';

  public deviationpage = '/dashboard/uccourriersortant';
  public actualcomp = '/dashboard/uccourrierentrant';
