...
@Component({
  selector: 'app-lb-courrier-entrant',
  templateUrl: './lb-courrier-entrant.component.html',
  styleUrls: ['./lb-courrier-entrant.component.scss']
})
export class LbCourrierEntrantComponent implements OnInit {
  ...
  public bdLink = 'lb-courriers-entrants';
  public storageLink = 'LB/CE/';
  public companytag = '/LB/';
  public doctype = '/CE/';

  public deviationpage = '/dashboard/lbcourriersortant';
  public actualcomp = '/dashboard/lbcourrierentrant';
