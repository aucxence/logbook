...
@Component({
  selector: 'app-note-service',
  templateUrl: './note-service.component.html',
  styleUrls: ['./note-service.component.scss']
})
export class NoteServiceComponent implements OnInit {
  ...
  public companystate = {
    type: 'une Note de Service',
    typepluriel: 'des Notes de Service',
    typeunique: 'la Note de Service',
    doctype: '/NS'
  }
