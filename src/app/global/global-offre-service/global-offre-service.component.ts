...
@Component({
  selector: 'app-global-offre-service',
  templateUrl: './global-offre-service.component.html',
  styleUrls: ['./global-offre-service.component.scss']
})
export class GlobalOffreServiceComponent implements OnInit {
  ...
  public companystate = {
    type: 'une Offre de service',
    typepluriel: 'des offres de service',
    typeunique: 'l\'offre de service',
    doctype: '/OS',
    // companyname: 'Instant Transfer',
    // bdLink: 'it-offres-services',
    // storageLink: 'IT/OS/',
    // companytag: '/IT/',
    // deviationpage: '/dashboard/itcourriersortant',
    // actualcomp: '/dashboard/offreservice'
  }
  ...
  public state = {
    [this.companies.biostar]: {
      ...this.companystate,
      companyname: 'BioSTAR',
      bdLink: 'bs-offres-services',
      storageLink: 'BS/OS/',
      companytag: '/BS/',
      deviationpage: '/dashboard/bscourriersortant',
      actualcomp: '/dashboard/offreservice/' + this.companies.biostar
    },
    [this.companies.technomed]: {
      ...this.companystate,
      companyname: 'Technologie Médicale',
      bdLink: 'tm-offres-services',
      storageLink: 'TM/OS/',
      companytag: '/TMCO/',
      deviationpage: '/dashboard/tmcourriersortant',
      actualcomp: '/dashboard/offreservice/' + this.companies.technomed
    },
    [this.companies.kamsu]: {
      ...this.companystate,
      companyname: 'Kamsu Tankeu Eugénie',
      bdLink: 'kte-offres-services',
      storageLink: 'KTE/OS/',
      companytag: '/KTE/',
      deviationpage: '/dashboard/ktecourriersortant',
      actualcomp: '/dashboard/offreservice/' + this.companies.kamsu
    },
    [this.companies.unicash]: {
      ...this.companystate,
      companyname: 'Universal Cash',
      bdLink: 'uc-offres-services',
      storageLink: 'UCASH/OS/',
      companytag: '/UCASH/',
      deviationpage: '/dashboard/uccourriersortant',
      actualcomp: '/dashboard/offreservice/' + this.companies.unicash
    },
    [this.companies.muffa]: {
      ...this.companystate,
      companyname: 'Muffa MC2 Kye Ossi',
      bdLink: 'mc2-offres-services',
      storageLink: 'MC2/OS/',
      companytag: '/MMKO/',
      deviationpage: '/dashboard/mc2courriersortant',
      actualcomp: '/dashboard/offreservice/' + this.companies.muffa
    },
    [this.companies.itransfer]: {
      ...
      companytag: '/IT/',
      deviationpage: '/dashboard/itcourriersortant',
      actualcomp: '/dashboard/offreservice/' + this.companies.itransfer
    }
  };
