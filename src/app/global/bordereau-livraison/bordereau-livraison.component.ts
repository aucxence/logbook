...
@Component({
  ...
  styleUrls: ['./bordereau-livraison.component.scss']
})
export class BordereauLivraisonComponent implements OnInit {
  ...
  public companystate = {
    type: 'un Bordereau de Livraison',
    typepluriel: 'des Bordereaux de Livraison',
    typeunique: 'le Bordereau de Livraison',
    doctype: '/BL'
  }
  ...
  public state = {
    [this.companies.biostar]: {
      ...this.companystate,
      companyname: 'BioSTAR',
      bdLink: 'bs-bordereaux-livraison',
      storageLink: 'BS/BL/',
      companytag: '/BS/',
      deviationpage: '/dashboard/bscourriersortant',
      actualcomp: '/dashboard/bordereaulivraison/' + this.companies.biostar
    },
    [this.companies.technomed]: {
      ...this.companystate,
      companyname: 'Technologie Médicale',
      bdLink: 'tm-bordereaux-livraison',
      storageLink: 'TM/BL/',
      companytag: '/TMCO/',
      deviationpage: '/dashboard/tmcourriersortant',
      actualcomp: '/dashboard/bordereaulivraison/' + this.companies.technomed
    },
    [this.companies.kamsu]: {
      ...this.companystate,
      companyname: 'Kamsu Tankeu Eugénie',
      bdLink: 'kte-bordereaux-livraison',
      storageLink: 'KTE/BL/',
      companytag: '/KTE/',
      deviationpage: '/dashboard/ktecourriersortant',
      actualcomp: '/dashboard/bordereaulivraison/' + this.companies.kamsu
    },
    [this.companies.unicash]: {
      ...this.companystate,
      companyname: 'Universal Cash',
      bdLink: 'uc-bordereaux-livraison',
      storageLink: 'UCASH/BL/',
      companytag: '/UCASH/',
      deviationpage: '/dashboard/uccourriersortant',
      actualcomp: '/dashboard/bordereaulivraison/' + this.companies.unicash
    },
    [this.companies.muffa]: {
      ...this.companystate,
      companyname: 'Muffa MC2 Kye Ossi',
      bdLink: 'mc2-bordereaux-livraison',
      storageLink: 'MC2/BL/',
      companytag: '/MMKO/',
      deviationpage: '/dashboard/mc2courriersortant',
      actualcomp: '/dashboard/bordereaulivraison/' + this.companies.muffa
    },
    [this.companies.itransfer]: {
      ...this.companystate,
      companyname: 'Instant Transfer',
      bdLink: 'it-bordereaux-livraison',
      storageLink: 'IT/BL/',
      companytag: '/IT/',
      deviationpage: '/dashboard/itcourriersortant',
      actualcomp: '/dashboard/bordereaulivraison/' + this.companies.itransfer
    }
  };
