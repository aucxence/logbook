...
@Component({
  selector: 'app-facture-definitive',
  templateUrl: './facture-definitive.component.html',
  styleUrls: ['./facture-definitive.component.scss']
})
export class FactureDefinitiveComponent implements OnInit {
  ...
  public companystate = {
    type: 'une Facture Définitive',
    typepluriel: 'des Factures Définitives',
    typeunique: 'la Facture Définitive',
    doctype: '/FCT/'
  }
  ...
  public state = {
    [this.companies.biostar]: {
      ...this.companystate,
      companyname: 'BioSTAR',
      bdLink: 'bs-factures-definitives',
      storageLink: 'BS/FCT/',
      companytag: '/BS/',
      deviationpage: '/dashboard/bscourriersortant',
      actualcomp: '/dashboard/facturedefinitive/' + this.companies.biostar
    },
    [this.companies.technomed]: {
      ...this.companystate,
      companyname: 'Technologie Médicale',
      bdLink: 'tm-factures-definitives',
      storageLink: 'TM/FCT/',
      companytag: '/TMCO/',
      deviationpage: '/dashboard/tmcourriersortant',
      actualcomp: '/dashboard/facturedefinitive/' + this.companies.technomed
    },
    [this.companies.kamsu]: {
      ...this.companystate,
      companyname: 'Kamsu Tankeu Eugénie',
      bdLink: 'kte-factures-definitives',
      storageLink: 'KTE/FCT/',
      companytag: '/KTE/',
      deviationpage: '/dashboard/ktecourriersortant',
      actualcomp: '/dashboard/facturedefinitive/' + this.companies.kamsu
    },
    [this.companies.unicash]: {
      ...this.companystate,
      companyname: 'Universal Cash',
      bdLink: 'uc-factures-definitives',
      storageLink: 'UCASH/FCT/',
      companytag: '/UCASH/',
      deviationpage: '/dashboard/uccourriersortant',
      actualcomp: '/dashboard/facturedefinitive/' + this.companies.unicash
    },
    [this.companies.muffa]: {
      ...this.companystate,
      companyname: 'Muffa MC2 Kye Ossi',
      bdLink: 'mc2-factures-definitives',
      storageLink: 'MC2/FCT/',
      companytag: '/MMKO/',
      deviationpage: '/dashboard/mc2courriersortant',
      actualcomp: '/dashboard/facturedefinitive/' + this.companies.muffa
    },
    [this.companies.itransfer]: {
      ...this.companystate,
      companyname: 'Instant Transfer',
      bdLink: 'it-factures-definitives',
      storageLink: 'IT/FCT/',
      companytag: '/IT/',
      deviationpage: '/dashboard/itcourriersortant',
      actualcomp: '/dashboard/facturedefinitive/' + this.companies.itransfer
    }
  };
  ...
  getRefComplete(lRow) {
    ...
    this.reference = 'N°' + this.lpad(lRow, 4) + this.relevantstate.doctype + f + this.relevantstate.companytag +
      destinataire + '/' + this.lpad(dayr, 2) + '' + this.lpad(monthr, 2) + '/' + yearr;
