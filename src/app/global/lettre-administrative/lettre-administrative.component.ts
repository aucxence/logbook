...
@Component({
  selector: 'app-lettre-administrative',
  templateUrl: './lettre-administrative.component.html',
  styleUrls: ['./lettre-administrative.component.scss']
})
export class LettreAdministrativeComponent implements OnInit {
  ...
  public companystate = {
    type: 'une Lettre Administrative',
    typepluriel: 'des Lettres Administratives',
    typeunique: 'la Lettre Administrative',
    doctype: '/LA/'
  };
  ...
  public state = {
    [this.companies.biostar]: {
      ...this.companystate,
      companyname: 'BioSTAR',
      bdLink: 'bs-lettres-administratives',
      storageLink: 'BS/LA/',
      companytag: '/BS/',
      deviationpage: '/dashboard/bscourriersortant',
      actualcomp: '/dashboard/lettreadministrative/' + this.companies.biostar
    },
    [this.companies.technomed]: {
      ...this.companystate,
      companyname: 'Technologie Médicale',
      bdLink: 'tm-lettres-administratives',
      storageLink: 'TM/LA/',
      companytag: '/TMCO/',
      deviationpage: '/dashboard/tmcourriersortant',
      actualcomp: '/dashboard/lettreadministrative/' + this.companies.technomed
    },
    [this.companies.kamsu]: {
      ...this.companystate,
      companyname: 'Kamsu Tankeu Eugénie',
      bdLink: 'kte-lettres-administratives',
      storageLink: 'KTE/LA/',
      companytag: '/KTE/',
      deviationpage: '/dashboard/ktecourriersortant',
      actualcomp: '/dashboard/lettreadministrative/' + this.companies.kamsu
    },
    [this.companies.unicash]: {
      ...this.companystate,
      companyname: 'Universal Cash',
      bdLink: 'uc-lettres-administratives',
      storageLink: 'UCASH/LA/',
      companytag: '/UCASH/',
      deviationpage: '/dashboard/uccourriersortant',
      actualcomp: '/dashboard/lettreadministrative/' + this.companies.unicash
    },
    [this.companies.muffa]: {
      ...this.companystate,
      companyname: 'Muffa MC2 Kye Ossi',
      bdLink: 'mc2-lettres-administratives',
      storageLink: 'MC2/LA/',
      companytag: '/MMKO/',
      deviationpage: '/dashboard/mc2courriersortant',
      actualcomp: '/dashboard/lettreadministrative/' + this.companies.muffa
    },
    [this.companies.itransfer]: {
      ...this.companystate,
      companyname: 'Instant Transfer',
      bdLink: 'it-lettres-administratives',
      storageLink: 'IT/LA/',
      companytag: '/IT/',
      deviationpage: '/dashboard/itcourriersortant',
      actualcomp: '/dashboard/lettreadministrative/' + this.companies.itransfer
    }
  };
  ...
  defineDocType(event, lRow) {
    console.log(event.target.dataset);
    this.relevantstate.doctype = event.target.options[event.target.selectedIndex].dataset.abbrev;
    this.getRefComplete(lRow);
  }
  ...
  getRefComplete(lRow) {
    ...
    this.reference = 'N°' + this.lpad(lRow, 4) + '/' + this.relevantstate.doctype + '' + this.relevantstate.companytag + concerne +
