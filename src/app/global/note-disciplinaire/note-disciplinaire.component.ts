...
@Component({
  selector: 'app-note-disciplinaire',
  templateUrl: './note-disciplinaire.component.html',
  styleUrls: ['./note-disciplinaire.component.scss']
})
export class NoteDisciplinaireComponent implements OnInit {
  ...
  public companystate = {
    type: 'un Document Disciplinaire',
    typepluriel: 'des Documents Disciplinaires',
    typeunique: 'le Document Disciplinaire',
    doctype: '/DD/'
  };
  ...
  public state = {
    [this.companies.biostar]: {
      ...this.companystate,
      companyname: 'BioSTAR',
      bdLink: 'bs-notes-disciplinaires',
      storageLink: 'BS/DD/',
      companytag: '/BS/',
      deviationpage: '/dashboard/bscourriersortant',
      actualcomp: '/dashboard/notedisciplinaire/' + this.companies.biostar
    },
    [this.companies.technomed]: {
      ...this.companystate,
      companyname: 'Technologie Médicale',
      bdLink: 'tm-notes-disciplinaires',
      storageLink: 'TM/DD/',
      companytag: '/TMCO/',
      deviationpage: '/dashboard/tmcourriersortant',
      actualcomp: '/dashboard/notedisciplinaire/' + this.companies.technomed
    },
    [this.companies.kamsu]: {
      ...this.companystate,
      companyname: 'Kamsu Tankeu Eugénie',
      bdLink: 'kte-notes-disciplinaires',
      storageLink: 'KTE/DD/',
      companytag: '/KTE/',
      deviationpage: '/dashboard/ktecourriersortant',
      actualcomp: '/dashboard/notedisciplinaire/' + this.companies.kamsu
    },
    [this.companies.unicash]: {
      ...this.companystate,
      companyname: 'Universal Cash',
      bdLink: 'uc-notes-disciplinaires',
      storageLink: 'UCASH/DD/',
      companytag: '/UCASH/',
      deviationpage: '/dashboard/uccourriersortant',
      actualcomp: '/dashboard/notedisciplinaire/' + this.companies.unicash
    },
    [this.companies.muffa]: {
      ...this.companystate,
      companyname: 'Muffa MC2 Kye Ossi',
      bdLink: 'mc2-notes-disciplinaires',
      storageLink: 'MC2/DD/',
      companytag: '/MMKO/',
      deviationpage: '/dashboard/mc2courriersortant',
      actualcomp: '/dashboard/notedisciplinaire/' + this.companies.muffa
    },
    [this.companies.itransfer]: {
      ...this.companystate,
      companyname: 'Instant Transfer',
      bdLink: 'it-notes-disciplinaires',
      storageLink: 'IT/DD/',
      companytag: '/IT/',
      deviationpage: '/dashboard/itcourriersortant',
      actualcomp: '/dashboard/notedisciplinaire/' + this.companies.itransfer
    }
  };
