...
@Component({
  ...
  styleUrls: ['./courrier-sortant.component.scss']
})
export class CourrierSortantComponent implements OnInit {
  ...
  public companystate = {
    ...
    typepluriel: 'des Courriers Sortants',
    typeunique: 'le Courrier Sortant',
    doctype: '/CS/'
  };
  ...
  public state = {
    [this.companies.biostar]: {
      ...this.companystate,
      companyname: 'BioSTAR',
      bdLink: 'bs-courriers-sortants',
      storageLink: 'BS/CS/',
      companytag: '/BS/',
      deviationpage: '/dashboard/bscourriersortant',
      actualcomp: '/dashboard/courriersortant/' + this.companies.biostar
    },
    [this.companies.technomed]: {
      ...this.companystate,
      companyname: 'Technologie Médicale',
      bdLink: 'tm-courriers-sortants',
      storageLink: 'TM/CS/',
      companytag: '/TMCO/',
      deviationpage: '/dashboard/tmcourriersortant',
      actualcomp: '/dashboard/courriersortant/' + this.companies.technomed
    },
    [this.companies.kamsu]: {
      ...this.companystate,
      companyname: 'Kamsu Tankeu Eugénie',
      bdLink: 'kte-courriers-sortants',
      storageLink: 'KTE/CS/',
      companytag: '/KTE/',
      deviationpage: '/dashboard/ktecourriersortant',
      actualcomp: '/dashboard/courriersortant/' + this.companies.kamsu
    },
    [this.companies.unicash]: {
      ...this.companystate,
      companyname: 'Universal Cash',
      bdLink: 'uc-courriers-sortants',
      storageLink: 'UCASH/CS/',
      companytag: '/UCASH/',
      deviationpage: '/dashboard/uccourriersortant',
      actualcomp: '/dashboard/courriersortant/' + this.companies.unicash
    },
    [this.companies.muffa]: {
      ...this.companystate,
      companyname: 'Muffa MC2 Kye Ossi',
      bdLink: 'mc2-courriers-sortants',
      storageLink: 'MC2/CS/',
      companytag: '/MMKO/',
      deviationpage: '/dashboard/mc2courriersortant',
      actualcomp: '/dashboard/courriersortant/' + this.companies.muffa
    },
    [this.companies.itransfer]: {
      ...this.companystate,
      companyname: 'Instant Transfer',
      bdLink: 'it-courriers-sortants',
      storageLink: 'IT/CS/',
      companytag: '/IT/',
      deviationpage: '/dashboard/itcourriersortant',
      actualcomp: '/dashboard/courriersortant/' + this.companies.itransfer
    }
  };
  ...
  getRefComplete(lRow) {
    ...
    this.reference = 'N°' + this.lpad(lRow, 4) + this.relevantstate.doctype + this.getInitials(b) + this.relevantstate.companytag +
  ...
  uploadITCS($event, avant: boolean, id: string, index) {
