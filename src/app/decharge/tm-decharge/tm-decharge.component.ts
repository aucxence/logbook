...
@Component({
  selector: 'app-tm-decharge',
  templateUrl: './tm-decharge.component.html',
  styleUrls: ['./tm-decharge.component.scss']
})
export class TmDechargeComponent implements OnInit {
  ...
  public bdLink = 'tm-decharges';
  public storageLink = 'TM/DCG/';
  public companytag = '/TM/';
  public doctype = '/DCG/';

  public deviationpage = '/dashboard/tmcourriersortant';
  public actualcomp = '/dashboard/tmdecharge';
