...
@Component({
  selector: 'app-mc2-decharge',
  templateUrl: './mc2-decharge.component.html',
  styleUrls: ['./mc2-decharge.component.scss']
})
export class Mc2DechargeComponent implements OnInit {
  ...
  public bdLink = 'mc2-decharges';
  public storageLink = 'MC2/DCG/';
  public companytag = '/MC2/';
  public doctype = '/DCG/';

  public deviationpage = '/dashboard/mc2courriersortant';
  public actualcomp = '/dashboard/mc2decharge';
