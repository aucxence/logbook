...
@Component({
  selector: 'app-bs-decharge',
  templateUrl: './bs-decharge.component.html',
  styleUrls: ['./bs-decharge.component.scss']
})
export class BsDechargeComponent implements OnInit {
  ...
  public bdLink = 'bs-decharges';
  public storageLink = 'BS/DCG/';
  public companytag = '/BS/';
  public doctype = '/DCG/';

  public deviationpage = '/dashboard/bscourriersortant';
  public actualcomp = '/dashboard/bsdecharge';
