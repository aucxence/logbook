...
@Component({
  selector: 'app-lb-decharge',
  templateUrl: './lb-decharge.component.html',
  styleUrls: ['./lb-decharge.component.scss']
})
export class LbDechargeComponent implements OnInit {
  ...
  public bdLink = 'lb-decharges';
  public storageLink = 'LB/DCG/';
  public companytag = '/LB/';
  public doctype = '/DCG/';

  public deviationpage = '/dashboard/lbcourriersortant';
  public actualcomp = '/dashboard/lbdecharge';
