...
@Component({
  selector: 'app-it-decharge',
  templateUrl: './it-decharge.component.html',
  styleUrls: ['./it-decharge.component.scss']
})
export class ItDechargeComponent implements OnInit {
  ...
  public bdLink = 'it-decharges';
  public storageLink = 'IT/DCG/';
  public companytag = '/IT/';
  public doctype = '/DCG/';

  public deviationpage = '/dashboard/itcourriersortant';
  public actualcomp = '/dashboard/itdecharge';
