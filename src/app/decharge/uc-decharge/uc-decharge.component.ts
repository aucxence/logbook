...
@Component({
  selector: 'app-uc-decharge',
  templateUrl: './uc-decharge.component.html',
  styleUrls: ['./uc-decharge.component.scss']
})
export class UcDechargeComponent implements OnInit {
  ...
  public bdLink = 'uc-decharges';
  public storageLink = 'UCASH/DCG/';
  public companytag = '/UCASH/';
  public doctype = '/DCG/';

  public deviationpage = '/dashboard/uccourriersortant';
  public actualcomp = '/dashboard/ucdecharge';
