...
@Component({
  selector: 'app-bs-pro-format',
  templateUrl: './bs-pro-format.component.html',
  styleUrls: ['./bs-pro-format.component.scss']
})
export class BsProFormatComponent implements OnInit {
  ...
  public bdLink = 'bs-factures-proformat';
  public storageLink = 'BS/FP/';
  public companytag = '/BS/';
  public doctype = '/FP';

  public deviationpage = '/dashboard/bscourriersortant';
  public actualcomp = '/dashboard/bsproformat';
