...
@Component({
  selector: 'app-tm-pro-format',
  templateUrl: './tm-pro-format.component.html',
  styleUrls: ['./tm-pro-format.component.scss']
})
export class TmProFormatComponent implements OnInit {
  ...
  public bdLink = 'tm-factures-proformat';
  public storageLink = 'TM/FP/';
  public companytag = '/TM/';
  public doctype = '/FP';

  public deviationpage = '/dashboard/tmcourriersortant';
  public actualcomp = '/dashboard/tmproformat';
