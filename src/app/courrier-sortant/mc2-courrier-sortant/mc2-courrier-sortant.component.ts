...
@Component({
  selector: 'app-mc2-courrier-sortant',
  templateUrl: './mc2-courrier-sortant.component.html',
  styleUrls: ['./mc2-courrier-sortant.component.scss']
})
export class Mc2CourrierSortantComponent implements OnInit {
  ...
  public bdLink = 'mc2-courriers-sortants';
  public storageLink = 'MC2/CS/';
  public companytag = '/MC2/';
  public doctype = '/CS/';

  public deviationpage = '/dashboard/mc2courrierentrant';
  public actualcomp = '/dashboard/mc2courriersortant';
  ...
  getRefComplete(lRow) {
    ...
    this.reference = 'N°' + this.lpad(lRow, 4) + this.doctype + this.getInitials(b) + this.companytag +
