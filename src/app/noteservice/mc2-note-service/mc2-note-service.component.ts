...
@Component({
  selector: 'app-mc2-note-service',
  templateUrl: './mc2-note-service.component.html',
  styleUrls: ['./mc2-note-service.component.scss']
})
export class Mc2NoteServiceComponent implements OnInit {
  ...
  public bdLink = 'mc2-notes-services';
  public storageLink = 'MC2/NS/';
  public companytag = '/MC2/';
  public doctype = '/NS';

  public deviationpage = '/dashboard/mc2courriersortant';
  public actualcomp = '/dashboard/mc2noteservice';
