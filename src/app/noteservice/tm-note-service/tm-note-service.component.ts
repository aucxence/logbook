...
@Component({
  selector: 'app-tm-note-service',
  templateUrl: './tm-note-service.component.html',
  styleUrls: ['./tm-note-service.component.scss']
})
export class TmNoteServiceComponent implements OnInit {
  ...
  public bdLink = 'tm-notes-services';
  public storageLink = 'TM/NS/';
  public companytag = '/TM/';
  public doctype = '/NS';

  public deviationpage = '/dashboard/tmcourriersortant';
  public actualcomp = '/dashboard/tmnoteservice';
