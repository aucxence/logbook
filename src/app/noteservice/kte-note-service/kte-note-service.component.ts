...
@Component({
  selector: 'app-kte-note-service',
  templateUrl: './kte-note-service.component.html',
  styleUrls: ['./kte-note-service.component.scss']
})
export class KteNoteServiceComponent implements OnInit {
  ...
  public bdLink = 'kte-notes-services';
  public storageLink = 'KTE/NS/';
  public companytag = '/KTE/';
  public doctype = '/NS';

  public deviationpage = '/dashboard/ktecourriersortant';
  public actualcomp = '/dashboard/ktenoteservice';
  ...
  getRefComplete(lRow) {
    ...
    this.reference = 'N°' + this.lpad(lRow, 4) + this.doctype + '' + this.companytag +
