...
@Component({
  selector: 'app-bs-note-service',
  templateUrl: './bs-note-service.component.html',
  styleUrls: ['./bs-note-service.component.scss']
})
export class BsNoteServiceComponent implements OnInit {
  ...
  public bdLink = 'bs-notes-services';
  public storageLink = 'BS/NS/';
  public companytag = '/BS/';
  public doctype = '/NS';

  public deviationpage = '/dashboard/bscourriersortant';
  public actualcomp = '/dashboard/bsnoteservice';
