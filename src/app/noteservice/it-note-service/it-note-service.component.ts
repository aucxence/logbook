...
@Component({
  selector: 'app-it-note-service',
  templateUrl: './it-note-service.component.html',
  styleUrls: ['./it-note-service.component.scss']
})
export class ItNoteServiceComponent implements OnInit {
  ...
  public bdLink = 'it-notes-services';
  public storageLink = 'IT/NS/';
  public companytag = '/IT/';
  public doctype = '/NS';

  public deviationpage = '/dashboard/itcourriersortant';
  public actualcomp = '/dashboard/itnoteservice';
