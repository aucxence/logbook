...
@Component({
  selector: 'app-lb-note-service',
  templateUrl: './lb-note-service.component.html',
  styleUrls: ['./lb-note-service.component.scss']
})
export class LbNoteServiceComponent implements OnInit {
  ...
  public bdLink = 'lb-notes-services';
  public storageLink = 'LB/NS/';
  public companytag = '/LB/';
  public doctype = '/NS';

  public deviationpage = '/dashboard/lbcourriersortant';
  public actualcomp = '/dashboard/lbnoteservice';
