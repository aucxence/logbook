...
@Component({
  selector: 'app-uc-note-service',
  templateUrl: './uc-note-service.component.html',
  styleUrls: ['./uc-note-service.component.scss']
})
export class UcNoteServiceComponent implements OnInit {
  ...
  public bdLink = 'uc-notes-services';
  public storageLink = 'UCASH/NS/';
  public companytag = '/UCASH/';
  public doctype = '/NS';

  public deviationpage = '/dashboard/uccourriersortant';
  public actualcomp = '/dashboard/ucnoteservice';
