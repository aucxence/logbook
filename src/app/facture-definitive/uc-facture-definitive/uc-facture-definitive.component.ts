...
@Component({
  selector: 'app-uc-facture-definitive',
  templateUrl: './uc-facture-definitive.component.html',
  styleUrls: ['./uc-facture-definitive.component.scss']
})
export class UcFactureDefinitiveComponent implements OnInit {
  ...
  datereception: Date;
  nomentreprise: string = 'Universal Cash';
  ...
  public bdLink = 'uc-factures-definitives';
  public storageLink = 'UCASH/FD/';
  public companytag = '/UCASH/';
  public doctype = '/FD';

  public deviationpage = '/dashboard/uccourriersortant';
  public actualcomp = '/dashboard/ucfacturedefinitive';
