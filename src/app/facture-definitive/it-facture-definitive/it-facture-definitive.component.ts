...
@Component({
  selector: 'app-it-facture-definitive',
  templateUrl: './it-facture-definitive.component.html',
  styleUrls: ['./it-facture-definitive.component.scss']
})
export class ItFactureDefinitiveComponent implements OnInit {
  ...
  datereception: Date;
  nomentreprise: string = 'Instant Transfer';
  ...
  public bdLink = 'it-factures-definitives';
  public storageLink = 'IT/FD/';
  public companytag = '/IT/';
  public doctype = '/FD';

  public deviationpage = '/dashboard/itcourriersortant';
  public actualcomp = '/dashboard/itfacturedefinitive';
