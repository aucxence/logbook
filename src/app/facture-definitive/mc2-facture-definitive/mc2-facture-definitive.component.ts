...
@Component({
  selector: 'app-mc2-facture-definitive',
  templateUrl: './mc2-facture-definitive.component.html',
  styleUrls: ['./mc2-facture-definitive.component.scss']
})
export class Mc2FactureDefinitiveComponent implements OnInit {
  ...
  public bdLink = 'mc2-factures-definitives';
  public storageLink = 'MC2/FD/';
  public companytag = '/MC2/';
  public doctype = '/FD';

  public deviationpage = '/dashboard/mc2courriersortant';
  public actualcomp = '/dashboard/mc2facturedefinitive';
