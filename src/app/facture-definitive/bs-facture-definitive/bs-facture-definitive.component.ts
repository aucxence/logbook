...
@Component({
  selector: 'app-bs-facture-definitive',
  templateUrl: './bs-facture-definitive.component.html',
  styleUrls: ['./bs-facture-definitive.component.scss']
})
export class BsFactureDefinitiveComponent implements OnInit {
  ...
  public bdLink = 'bs-factures-definitives';
  public storageLink = 'BS/FD/';
  public companytag = '/BS/';
  public doctype = '/FD';

  public deviationpage = '/dashboard/bscourriersortant';
  public actualcomp = '/dashboard/bsfacturedefinitive';
