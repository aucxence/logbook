...
@Component({
  selector: 'app-tm-facture-definitive',
  templateUrl: './tm-facture-definitive.component.html',
  styleUrls: ['./tm-facture-definitive.component.scss']
})
export class TmFactureDefinitiveComponent implements OnInit {
  ...
  datereception: Date;
  nomentreprise: string = 'Technologie Médicale Company';
  ...
  public bdLink = 'tm-factures-definitives';
  public storageLink = 'TM/FD/';
  public companytag = '/TM/';
  public doctype = '/FD';

  public deviationpage = '/dashboard/tmcourriersortant';
  public actualcomp = '/dashboard/tmfacturedefinitive';
