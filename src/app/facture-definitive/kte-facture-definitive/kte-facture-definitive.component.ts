...
@Component({
  selector: 'app-kte-facture-definitive',
  templateUrl: './kte-facture-definitive.component.html',
  styleUrls: ['./kte-facture-definitive.component.scss']
})
export class KteFactureDefinitiveComponent implements OnInit {
  ...
  datereception: Date;
  nomentreprise: string = 'Kamsu Tankeu Eugénie';
  ...
  public bdLink = 'kte-factures-definitives';
  public storageLink = 'KTE/FD/';
  public companytag = '/KTE/';
  public doctype = '/FD';

  public deviationpage = '/dashboard/ktecourriersortant';
  public actualcomp = '/dashboard/ktefacturedefinitive';
  ...
  getRefComplete(lRow) {
    ...
    this.reference = 'N°' + this.lpad(lRow, 4) + '/' + entreprise + '/' + destinataire +
